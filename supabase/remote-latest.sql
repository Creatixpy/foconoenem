...
CREATE TABLE IF NOT EXISTS "public"."community_comments" (
    ...
    CONSTRAINT "community_comments_status_check" CHECK (("status" = ANY (ARRAY['visible'::"text", 'hidden'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."community_posts" (
    ...
    CONSTRAINT "community_posts_status_check" CHECK (("status" = ANY (ARRAY['published'::"text", 'archived'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    ...
    "community_show_statistics" boolean DEFAULT true NOT NULL,
    "community_terms_version" "text",
    "community_terms_accepted_at" timestamp with time zone,
    "community_age_confirmed_at" timestamp with time zone,
    "is_over_16" boolean,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
ALTER TABLE ONLY "public"."community_post_likes"
    ADD CONSTRAINT "community_post_likes_unique_like" UNIQUE ("post_id", "user_id");
...
ALTER TABLE ONLY "public"."community_topics"
    ADD CONSTRAINT "community_topics_slug_key" UNIQUE ("slug");
...
CREATE INDEX "idx_community_comments_user" ON "public"."community_comments" USING "btree" ("user_id", "created_at" DESC);



CREATE INDEX "idx_community_post_likes_post" ON "public"."community_post_likes" USING "btree" ("post_id");
...
CREATE INDEX "idx_community_posts_topic" ON "public"."community_posts" USING "btree" ("topic_id", "created_at" DESC);



CREATE INDEX "idx_community_posts_user" ON "public"."community_posts" USING "btree" ("user_id", "created_at" DESC);
...
CREATE OR REPLACE TRIGGER "trg_community_comments_updated_at" BEFORE UPDATE ON "public"."community_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "trg_community_posts_updated_at" BEFORE UPDATE ON "public"."community_posts" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "trg_community_topics_updated_at" BEFORE UPDATE ON "public"."community_topics" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."community_posts"
    ADD CONSTRAINT "community_posts_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "public"."community_topics"("id") ON DELETE CASCADE;
...
CREATE POLICY "community_comments_select_public" ON "public"."community_comments" FOR SELECT USING (("status" = 'visible'::"text"));



CREATE POLICY "community_comments_service" ON "public"."community_comments" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "community_likes_select_public" ON "public"."community_post_likes" FOR SELECT USING (true);



CREATE POLICY "community_likes_service" ON "public"."community_post_likes" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "community_posts_select_public" ON "public"."community_posts" FOR SELECT USING (("status" = 'published'::"text"));



CREATE POLICY "community_posts_service" ON "public"."community_posts" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "community_topics_manage_service" ON "public"."community_topics" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "community_topics_select_public" ON "public"."community_topics" FOR SELECT USING (true);
