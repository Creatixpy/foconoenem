...
\copy (select * from public.community_topics order by created_at) to :'output_dir'/community_topics.csv csv header;
\copy (select * from public.community_posts order by created_at) to :'output_dir'/community_posts.csv csv header;
\copy (select * from public.community_comments order by created_at) to :'output_dir'/community_comments.csv csv header;
\copy (select * from public.community_post_likes order by created_at) to :'output_dir'/community_post_likes.csv csv header;
