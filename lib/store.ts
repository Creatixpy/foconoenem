...
export async function getResult(id: string): Promise<EssayResult | null> {
  try {
    ...
    return {
      id: data.id,
      nota: data.nota,
      competencia1: data.competencia1 as EssayResult['competencia1'],
      competencia2: data.competencia2 as EssayResult['competencia2'],
      competencia3: data.competencia3 as EssayResult['competencia3'],
      competencia4: data.competencia4 as EssayResult['competencia4'],
      competencia5: data.competencia5 as EssayResult['competencia5'],
