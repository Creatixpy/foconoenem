...
export default function Footer() {
    ...
    return (
        <footer
            className="mt-auto border-t border-border-color bg-card-bg pt-12 pb-8"
            role="contentinfo"
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
                    ...
                    <div className="md:col-span-2 lg:col-span-2">
                        ...
                        <p className="text-sm text-foreground/60 max-w-sm leading-relaxed">
                            Sua plataforma completa para preparação do ENEM. Redações com IA,
                            banco de questões e uma comunidade engajada para te levar à aprovação.
                        </p>
                    </div>
                ...
                {/* Bottom Bar */}
                <div className="mt-12 border-t border-border-color pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
