...
export default function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // OAuth will redirect, so keep loading state
    } catch {
    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-card-bg rounded-2xl shadow-xl p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              autoFocus
              disabled={loading}
              className="w-full px-4 py-3 rounded-xl border border-border-color bg-background text-foreground placeholder-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loading}
                className="w-full px-4 py-3 pr-12 rounded-xl border border-border-color bg-background text-foreground placeholder-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                placeholder="••••••••"
              />
              <button
                type="button"
        ...
        <p className="mt-8 text-center text-sm text-foreground/60">
          Não tem uma conta?{' '}
          <Link
            href={`${AUTH_PATHS.REGISTER}?next=${encodeURIComponent(redirectTo)}`}
