      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 p-8 sm:p-10 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8">
            Enviamos um email de confirmação para <strong className="text-slate-700 dark:text-slate-300">{email}</strong>.
            <br />
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="block w-full py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            >
              Voltar ao cadastro
            </button>
          </div>
    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="objetivo" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
              Seu objetivo no ENEM <span className="text-slate-400">(opcional)</span>
            </label>
            <input
              id="objetivo"
              type="text"
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center">
            <span className="px-4 text-xs font-medium text-slate-400 dark:text-slate-500 bg-white dark:bg-slate-800 uppercase tracking-wider">
              ou
            </span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
        >
        ...
        <p className="mt-4 text-center text-xs text-slate-400 dark:text-slate-500">
          ...
          <a href="/termos" className="underline hover:text-slate-600 dark:hover:text-slate-300">
            Termos de Uso
          </a>{' '}
          e{' '}
          <a href="/privacidade" className="underline hover:text-slate-600 dark:hover:text-slate-300">
